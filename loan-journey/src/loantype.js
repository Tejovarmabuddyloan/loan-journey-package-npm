    ...
    >
      ...
      <View>
        ...
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.prompt}>What Type of Loan?</Text>
          
       
          <View style={styles.input}>
  <Text style={styles.inputText}>Personal Loan</Text>
  <TouchableOpacity onPress={() => {
    savePartialLoanData('loanType', '1',mobileNum);
    navigation.navigate('Employmenttypescreen');
  }}>
...
<View style={styles.input}>
  <Text style={styles.inputText}>Business Loan</Text>
  <TouchableOpacity onPress={() => {
    savePartialLoanData('loanType', '2',mobileNum);
    savePartialLoanData('self_employement_type',"1",mobileNum);
    savePartialLoanData('emplyoment_type',"2",mobileNum);


    navigation.navigate('BusinessProofscreen');
  }}>
  <Image source={require('../assets/images/radiobtnalt.png')} style={styles.inputImage} />
  </TouchableOpacity>
  {/* <Image source={require('../assets/images/radiobtnalt.png')} style={styles.inputImage} /> */}
