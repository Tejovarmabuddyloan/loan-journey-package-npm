...
// // const SelfEmployedcommunicationDetailsScreen = () => {
...
// //   <TouchableOpacity onPress={() => {
// //     navigation.navigate('SelfEmployedBankDetailsScreen');
// //   }}>
...
// // export default SelfEmployedcommunicationDetailsScreen;
...
//       savePartialLoanData('city','Bangalore',mobileNum);
//       savePartialLoanData('state','Karnataka',mobileNum);

//       // If both loan amount and email are valid, navigate to the next page
//       // save_partial_loandata('accomodation_type',accomondationtypeid,user);
//       // save_partial_loandata('current_addr_month',user.noofmonthsatcuraddr,user);
//       // save_partial_loandata('pincode',user.pincode,user);
//       // save_partial_loandata('city',user.city,user);
//       // save_partial_loandata('state',user.state,user);
//       navigation.navigate('SelfEmployedBankDetailsScreen');
//     } else {
...
//     } else {
//       setSelectedValue2("CurrentLivingAddress");
//     }
