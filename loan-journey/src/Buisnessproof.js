    ...
    >
      ...
      <View>
        ...
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.prompt}>Do You Any Business Proof?</Text>
          <Text style={styles.prompt2}> (Ex - GST, Udyam, Shop & Establishment,{'\n'}Gumasta, FSSAI License.)</Text>      
          <View style={[styles.input,styles.bottomspace]}>
  <Text style={[styles.inputText]}>Yes</Text>
  <TouchableOpacity onPress={() => {
    savePartialLoanData('salary_mode', '1',mobileNum);
    savePartialLoanData('self_employement_type', '1',mobileNum);
    savePartialLoanData('emplyoment_type', '2',mobileNum);
    //  save_partial_loandata('self_employement_type',"1",user);
    //  save_partial_loandata('emplyoment_type',"2",user);
    //  save_partial_loandata('salary_mode',"1",user);
...
export default BusinessProofscreen;
