...
const Salarymodescreen = () => {
    ...
    >
      ...
      <View>
        ...
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.prompt}>Choose Salary Mode</Text>
       
          <View style={styles.input}>
  <Text style={styles.inputText}>Salary in Bank</Text>
  <TouchableOpacity onPress={() => {
    ...
    navigation.navigate('SalaryworkDetailsScreen');
  }}>
...
<View style={styles.input}>
  <Text style={styles.inputText}>Salary in Cash</Text>
  <TouchableOpacity onPress={() => {
...
export default Salarymodescreen;
